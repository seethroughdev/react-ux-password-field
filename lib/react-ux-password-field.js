	    ...
	    if (this.props.infoBar) {
	      infoBar = React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('img', { src: this.props.lockIconLight ? __webpack_require__(6) : __webpack_require__(5), height: '10', width: '10' })
	        ),
